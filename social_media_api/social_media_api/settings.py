...
# Database (PostgreSQL/MySQL for production, SQLite fallback for dev)
DATABASES = {
    'default': {
...
# Static & Media (with AWS S3 option for production)
STATIC_URL = '/static/'
...
# AWS S3 storage for static & media (optional)
